...
class Keithley2400:
    ...
    def __init__(self,func):
        ...
        #Depending on instrument GPIB address. or K2400, GPIB address is 20
        self.keithley2400 = self.rm.open_resource('GPIB::20')
        self.keithley2400.write("*rst; status:preset; *cls")#Reset K2400
        self.keithley2400.write(":SYST:RSEN OFF") #set mode, 2-wire:OFF / 4-wire:ON
        print("initialized")
