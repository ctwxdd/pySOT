    ...
    def event():
        ...
        while Hx_start>=Hx_end:
            ...
            while current < current_max :
                ...
                tmp=double(1000*data[1]/current_sense) # Voltage from K2000 / 0.1mA
                result.append(tmp)
                values_y.append(tmp)
            ...
            file = open(str(directory)+"/MR_STT_switching_"+str(Hx_start)+"Oe_"+str(stamp), "w")
