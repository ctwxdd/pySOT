...
class Keithley2400:
    ...
    def __init__(self): #if want to use func (line 15) add back in here
    ...
    def setCurrent(self, current):
        ...
        self.keithley2400.write(":SOUR:CURR:RANG 10e-3") #set range to 100mA
    ...
    def setVoltage(self, voltage):
        ...
        self.keithley2400.write(":SOUR:FUNC VOLT")
        self.keithley2400.write(":SOUR:VOLT:MODE FIX")
        self.keithley2400.write(":SOUR:VOLT:RANG 5") #set range to 5V
        self.keithley2400.write(":SOUR:VOLT:LEV %f" %voltage)
        print("Keithley2400 voltage set to: %f V" %voltage)
    ...
    def vpulse(self,voltage, voltage_max,trigger_delay,source_delay):
        ...
        #self.keithley2400.write(":SENS:VOLT:RANG 5") #set voltage range to 5V
...
if __name__ == '__main__':
    ...
    print()
    new = Keithley2400()
    new.vpulse( voltage = 1.5, voltage_max= 2, trigger_delay=0.1, source_delay=0.1)
